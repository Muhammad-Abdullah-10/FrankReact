...
const homePageData = {
    ...
    slides: [
      {
        ...
        bannerImg: "assets/img/FrankPorter_main_baner_1.jpeg",
        buttons: [
          {
      ...
      },
      {
        title: "Airbnb Management Dubai",
        subtitle: "Premier property management for short-term rentals across Dubai",
        bannerImg: "assets/img/FrankPorter_main_baner_2.jpeg",
        buttons: [
          {
            text: "Manage My Property",
            link: "#",
      ...
      },
      {
        title: "Airbnb Management Dubai",
        subtitle: "Premier property management for short-term rentals across Dubai",
        bannerImg: "assets/img/FrankPorter_main_baner_3.jpeg",
        buttons: [
          {
            text: "Manage My Property",
            link: "#",
  ...
  logoSection: {
    logos: [
      { src: "assets/img/news-logo/arabianBusiness.svg", alt: "Arabian Business" },
      { src: "assets/img/news-logo/forbesMiddleEast.svg", alt: "Forbes Middle East" },
      { src: "assets/img/news-logo/gulfNews.svg", alt: "Gulf News" },
      { src: "assets/img/news-logo/khaleejTimes.svg", alt: "Khaleej Times" },
      { src: "assets/img/news-logo/theNational.svg", alt: "The National" },
      { src: "assets/img/news-logo/arabianBusiness.svg", alt: "Arabian Business" },
      { src: "assets/img/news-logo/forbesMiddleEast.svg", alt: "Forbes Middle East" },
      { src: "assets/img/news-logo/zawya.svg", alt: "Zawya" },
      { src: "assets/img/news-logo/dubaiOne.svg", alt: "Dubai One" },
      { src: "assets/img/news-logo/theNational.svg", alt: "The National" }
    ],
    scrollDuration: "15s" 
    },
    ...
    aboutSections: {
        leftSections: [
        {
            ...
            imgUrl: "assets/img/apartment-dining-room.jpeg",
        },
        {
            id: 2,
            ...
            imgUrl: "assets/img//13_IMG_6481-HDR-Edit-1.png",
        },
        ],
        ...
        rightSections: [
        {
            ...
            imgUrl: "assets/img/IMG_5197.jpeg",
        },
        {
            id: 2,
            ...
            imgUrl: "assets/img/02_1L1A1062-HDR_OK-min.jpeg",
        },
        {
            id: 3,
            ...
            imgUrl: "assets/img/table_flower.png",
        },
        ],
    },
    ...
    testimonials: [
      {
        name: "Sajna",
        role: "Owner",
        image: "assets/img/IMG_5197.jpeg",
        quote:
      ...
      },
      {
        name: "Ahmed",
        role: "Investor",
        image: "assets/img/IMG_5198.jpeg",
        quote:
      ...
      },
      {
        name: "Fatima",
        role: "Owner",
        image: "assets/img/IMG_5199.jpeg",
        quote:
      ...
      },
      {
        name: "Omar",
        role: "Host",
        image: "assets/img/IMG_5200.jpeg",
        quote:
      ...
      },
      {
        name: "Leila",
        role: "Investor",
        image: "assets/img/IMG_5201.jpeg",
        quote:
