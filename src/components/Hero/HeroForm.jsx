        ...
        <div className="main-container-form-banner lg:container lg:mx-auto rounded p-[20px] w-full md:max-h-[300px] lg:w-[75%]" >
          <div className="wrapper-content">
            ...
            <form className="form-banner p-[15px] lg:my-[20px] my-[10px] flex flex-col md:flex-row  justify-between" action="">
              ...
              <button type="submit" className="bg-blackButton hover:bg-secondary w-full md:w-[23%] my-[10px] md:my-0 md:mx-auto h-auto font-futuraLight text-[#2d2d2d2]  font-bold text-[12px] py-[10px] rounded-[5px]
            text-center uppercase text-white  border-[#2D2D2C] hover:border-secondary border-[2px] border-solid tracking-wide hover:text-white hover:font-[600]">
              Calculate
            </button>
            </form>
          </div>
