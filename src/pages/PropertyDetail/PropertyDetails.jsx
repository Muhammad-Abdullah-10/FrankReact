    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="flex flex-col md:max-w-4/5 3xl:max-w-3/4  mx-auto mb-[20px] border-b-[2px] border-solid border-[#8d7252] pb-[20px]">
            ...
            <div class="flex flex-col md:w-[200px] items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/guest.eec24d13.svg" alt="" />
                <h4 class="font-futuraLight font-[600] text-[18px] mb-[20px] ">7 guests</h4>
            </div>
            <div class="flex flex-col md:w-[200px] items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/room.ea1068b3.svg" alt="" />
                <h4 class="font-futuraLight font-[600] text-[18px] mb-[20px] ">3 rooms</h4>
            </div>
            <div class="flex flex-col md:w-[200px] items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/beds.671db9b2.svg" alt="" />
                <h4 class="font-futuraLight font-[600] text-[18px] mb-[20px] ">3 beds</h4>
            </div>
            <div class="flex flex-col md:w-[200px] items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/bathroom.9577d95a.svg" alt="" />
        ...
        <div class="flex flex-col md:flex-row  md:max-w-4/5 3xl:max-w-3/4  mx-auto mb-[20px] border-b-[2px] border-solid border-[#8d7252] pb-[20px]">
            ...
            <div class="flex flex-col md:w-auto items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/wheelchair.6c96e15d.svg" alt="" />
                <h4 class="font-futuraLight font-[400] text-[18px] mb-[20px] text-center ">Wheelchair Accessible</h4>
            </div>
            <div class="flex flex-col md:w-auto items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/gym.86a45136.svg" alt="" />
                <h4 class="font-futuraLight font-[400] text-[18px] mb-[20px] text-center ">Gym</h4>
            </div>
            <div class="flex flex-col md:w-auto items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/pool.8add63db.svg" alt="" />
                <h4 class="font-futuraLight font-[400] text-[18px] mb-[20px] text-center ">Outdoor Pool</h4>
            </div>
            <div class="flex flex-col md:w-auto items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/air_condition.72d3dc24.svg" alt="" />
                <h4 class="font-futuraLight font-[400] text-[18px] mb-[20px] text-center ">Central air conditioning</h4>
            </div>
            <div class="flex flex-col md:w-auto items-center">
                <img class="max-w-[4em]  object-cover mb-[20px]"  src="../../src/assets/img/icons/wifi.be099a40.svg" alt="" />
        ...
        <div class="flex flex-col my-[20px]">
            <img src="../../src/assets/img/02_1L1A1062-HDR_OK-min.jpeg" alt="" />
        </div>
        </div>
    </div>
    </>
